...
def _product_from_row(row: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "subcategoria_nivel_2": row.get("subcategoria_nivel_2") or row.get("subcategoria_nivel2"),
        "familia_visual": row.get("familia_visual"),
        "nm_fabricante": row.get("nm_fabricante") or row.get("fabricante"),
        "is_pesado": row.get("is_pesado"),
        "is_alto": row.get("is_alto"),
        "is_altinho": row.get("is_altinho"),
